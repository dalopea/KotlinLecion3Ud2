package com.example.kotlinlecion3ud2
...
import com.example.kotlinlecion3ud2.ui.theme.KotlinLEcion3Ud2Theme
...
fun TipTimeLayout() {
    ...
    Column(
        ...
        EditNumberField(label=R.string.bill_amount,
            ...
            value=amountInput,onValueChanged={amountInput=it},modifier= Modifier
...
fun EditNumberField(@StringRes label:Int,keyboardOptions: KeyboardOptions, value:String, onValueChanged:(String)->Unit, modifier:Modifier=Modifier){
    ...
    TextField(value = value, onValueChange = onValueChanged,modifier=modifier,
        label={Text(stringResource(id = label))}, singleLine = true,
